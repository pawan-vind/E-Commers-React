...
import { fetchAllProductAsync, fetchProductsByFilterAsync, selectAllProducts, selectTotalItems } from "../ProductSlice";
...
const filters = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: "womens-shoe", label: "womens-shoe", checked: false },
