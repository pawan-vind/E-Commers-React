...
import { fetchAllProductAsync, fetchBrandsAsync, fetchCategoryAsync, fetchProductsByFilterAsync, selectAllProducts, selectBrands, selectCategory, selectTotalItems } from "../../product-list/ProductSlice";
import { fetchAllProducts } from "../../product-list/ProductAPI";
import { ITEMS_PER_PAGE } from "../../../app/constant";
import { selectLoggedInUser, selectloggedInUser } from "../../Auth/AuthSlice";
import { fetchLoggedInUserOrdersAsync, selectUserInfo } from "../../user/userSlice";
const sortOptions = [
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div className="lg:col-span-3">
                ...
                type="submit"
                className="rounded-md mx-5 bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Add Product
              </Link>
                </div>
                    ...
                    <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3   xl:gap-x-8">
                      {
                        ...
                        <div key={product.id} className="group relative border-solid border-2 p-2 border-grey-200">
                          ...
                          {product.deleted ? <div>
                            <p className="text-xs text-red-500">Product Deleted</p>
                          </div>: null}
